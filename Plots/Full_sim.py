...
ax0.plot([t_onset2,t_onset2], [-0.1, 1.1], "k:", alpha=0.5)
ax0.plot([t_offset2,t_offset2], [-0.1, 1.1], "k:", alpha=0.5)
...
"""
data1 = np.loadtxt("../Output_full_sim/states_time_neus%s_gamma%s_P%s_tau%s_dt%s_chat%s_A%s_rm%s_b%s.dat"%(N, gamma, P, tau, h, C_hat, A, rm, b), unpack=True)

for i in range(1,N):
    ax1.plot(data1[0,:],data1[i,:], lw=linewidth)
...
ax1.plot([t_onset2,t_onset2], [-0.1, 1.1], "k:", alpha=0.5)
ax1.plot([t_offset2,t_offset2], [-0.1, 1.1], "k:", alpha=0.5)
...
ax3.plot([t_onset2,t_onset2], [-0.1, 1.1], "k:", alpha=0.5)
ax3.plot([t_offset2,t_offset2], [-0.1, 1.1], "k:", alpha=0.5)
...
plt.savefig("../Figures_full_sim/N%s_gamma%s_P%s_A%s_rm%s_beta%s_h0%s_tau%s_h%s_ton%s_toff%s_C_hat%s.pdf"%(N, gamma, P, A, rm, beta, h0, tau, h, t_onset, t_offset, C_hat),   transparent=True)
plt.show()
...
sigma = 0.0141230
noise_distr = np.loadtxt("../Output_full_sim/final_noise_ditr_N%s_gamma%s_P%s_tau%s_dt%s_chat%s_A%s_rm%s_b%s.dat"%(N, gamma, P, tau, h, C_hat, A, rm, b), unpack=True)
